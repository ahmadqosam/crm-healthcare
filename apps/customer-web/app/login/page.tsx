            ...
            <div className="hidden lg:flex w-1/2 bg-blue-900 text-white flex-col justify-center px-12 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <h2 className="text-4xl font-bold leading-tight mb-6">
                        Redefining Healthcare <br /> Patient Support.
                    </h2>
                    <p className="text-blue-100 text-lg leading-relaxed">
                        Connect seamlessly with your healthcare providers.
                        Secure, efficient, and always available when you need it most.
                    </p>
                </div>
            </div>
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <Link href="/register" className="font-medium text-blue-900 hover:text-blue-800 hover:underline transition-colors">
                                    Create free account
                                </Link>
                            </p>
                        </div>
